...
class ArduinoConnection:
    ...
    def __init__(self, serial: Serial) -> None:
        ...
        self._set_state = Command(0x10, (Primitives.i8,))
        self._send_ans = Command(0x11, (Primitives.i8,))
        
    def set_state(self, state: int):
        self._serial.write(self._set_state.pack(state))
        
    def send_ans(self, ans: int):
        self._serial.write(self._send_ans.pack(ans))   
