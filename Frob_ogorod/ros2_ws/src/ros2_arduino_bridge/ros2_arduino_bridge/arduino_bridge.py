...
#        self.left_speed_pub = self.create_publisher(Int32, 'left_motor/encoder/delta', 10)
 #       self.right_speed_pub = self.create_publisher(Int32, 'right_motor/encoder/delta', 10)
        ...
        self.states = {1: "Выключение робота",
                       2: "Старт"}
                       
    def plants_callback(self, msg):
        	self._connect.set_servo(msg.data)
        	print("А-а-а-а-а-а-а фрукт!!!")
    	
    def state_callback(self, msg):
        self._connect.set_state(msg.data)
        print(self.states[msg.data])
