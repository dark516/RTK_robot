...
class ArduinoConnection:
    ...
    def __init__(self, serial: Serial) -> None:
        ...
        self._set_state = Command(0x14, (Primitives.i8,))
        self._set_servo = Command(0x15, (Primitives.i8,))
    ...
    def set_state(self, state: int):
        self._serial.write(self._set_state.pack(state))
    
    def set_servo(self, state: int):
    	    self._serial.write(self._set_servo.pack(state))
